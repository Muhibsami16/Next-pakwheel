...
export default function Navbar() {
  return (
    <div>
      ...
      <Link href="/">
        <Image className="mt-12 ml-44" src="/logo.svg" width={160} height={140} alt="Pak wheels logo" />
        </Link>
        <ul className="flex w-full text-white gap-16 justify-end pt-10 mt-6 mr-2">
          <li>Used Cars</li>
          <li>New Cars</li>
          <li>Bikes</li>
          <li>Auto Store</li>
