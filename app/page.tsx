  ...
  return (
    <div>
      ...
      <div className=" bg-gradient-to-b from-[#000001] to-[#012864]">
        <header>
          <h1 className="items-center text-white text-center w-full pt-28 text-4xl">
            Find Used Cars in Pakistan
          </h1>
          <p className="items-center text-white text-center w-full pt-0 p-2 text-xl ">
      ...
      <header>
        <h1 className="item-center text-start font-bold text-2xl w-full p-8 pl-28 text-[#404040]">
          ...
          <ul className="flex text-start text-[#434343] text-xl ml-32 pt-0 gap-10">
            ...
            <li className="font-bold hover:underline hover:underline-offset-8">Upcoming</li>
            <li className="font-bold hover:underline hover:underline-offset-8">Newly Launched</li>
          </ul>
        <nav className="flex justify-center items-center gap-x-4 bg-transparent h-96 w-full">
          ...
          <li className="text-[#7b8397] text-sm pt-1">*****  711 Reviews</li>
          </ul>
          </div>
          ...
          <li className="text-[#7b8397] text-sm pt-1">*****  243 Reviews</li>
          </ul>
          </div>
          <div className="flex justify-center items-center bg-[#ffffff] h-72 w-1/4 text-center">
          <ul>
          ...
          <li className="text-[#7b8397] text-sm pt-1">*****  408 Reviews</li>
          </ul>
          </div>
          ...
          <li className="text-[#7b8397] text-sm pt-1">*****  768 Reviews</li>
          </ul>
          </div>
        </nav>
      </header>
